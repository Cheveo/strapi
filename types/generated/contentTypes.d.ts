...
export interface ApiCardCard extends Schema.CollectionType {
  ...
  attributes: {
    ...
    link: Attribute.Relation<'api::card.card', 'oneToOne', 'api::link.link'>;
...
export interface ApiHomeHome extends Schema.SingleType {
  ...
  attributes: {
    ...
    process: Attribute.Relation<
      ...
      'api::card.card'
    >;
    profile_cards: Attribute.Relation<
      'api::home.home',
      'oneToMany',
      'api::profile-card.profile-card'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiProfileCardProfileCard extends Schema.CollectionType {
  collectionName: 'profile_cards';
  info: {
    singularName: 'profile-card';
    pluralName: 'profile-cards';
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::profile-card.profile-card': ApiProfileCardProfileCard;
    }
  }
}
